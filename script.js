 ...
 * ========================================
 * 
 * All configuration keys MUST use snake_case format:
 * 
 * ✓ CORRECT:   field_order, group_by, title_field, user_permissions
 * ✗ INCORRECT: fieldOrder, groupBy, titleField, userPermissions
 * 
 * This convention matches ERPNext backend standards and ensures consistency.
 * 
              ...
              ${(() => {
                ...
                if (savedFieldOrder.length > 0) {
                  ...
                  savedFieldOrder.forEach(fieldname => {
                    const colIndex = remainingColumns.findIndex(c => c.fieldname === fieldname);
                    if (colIndex >= 0) {
